        ...
        <div className="row">
          ...
          <div className="col col-d-6 col-t-6 col-m-12 border-line-v">
            <div className="skills-list">
              <div className="skill-title border-line-h">
                ...
                <div className="name">Client-Side</div>
              </div>
              <ul>
          ...
          <div className="col col-d-6 col-t-6 col-m-12 border-line-v">
            <div className="skills-list">
              <div className="skill-title border-line-h">
                ...
                <div className="name">Server-Side</div>
              </div>
              <ul>
                <li className="border-line-h">
          ...
          <div className="col col-d-6 col-t-6 col-m-12 border-line-v">
            <div className="skills-list circles">
              ...
              <ul>
                ...
                <li>
                  <div className="name">TailwindCss</div>
          ...
          <div className="col col-d-6 col-t-6 col-m-12 border-line-v">
            <div className="skills-list list">
              ...
              <ul>
                <li>
                  <div className="name">Introduction to Leadership course by Harvard</div>
                </li>
                <li>
                  <div className="name">Attended a Communication course at Stanford</div>
                </li>
                {/* <li>
